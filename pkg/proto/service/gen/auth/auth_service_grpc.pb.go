...
const (
	AuthService_InitSession_FullMethodName  = "/service.auth.AuthService/InitSession"
	AuthService_RegisterUser_FullMethodName = "/service.auth.AuthService/RegisterUser"
)
...
func (c *authServiceClient) InitSession(ctx context.Context, in *InitSessionRequest, opts ...grpc.CallOption) (*InitSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InitSessionResponse)
	err := c.cc.Invoke(ctx, AuthService_InitSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) InitSession(context.Context, *InitSessionRequest) (*InitSessionResponse, error) {
...
func _AuthService_InitSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_InitSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).InitSession(ctx, req.(*InitSessionRequest))
	}
